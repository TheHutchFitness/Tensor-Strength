...
const PUBLIC_PATHS = ['/login', '/landing', '/checkout', '/free-programs', '/programs', '/meet-the-team', '/professionals', '/apply', '/macros', '/auth/emergent/callback', '/offline.html', '/manifest.webmanifest', '/sw.js']
